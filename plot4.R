...
############ Create Multiple Base Plots for Plot 4
par(mfrow = c(2,2), cex = 0.8)
with(subdata, {
        # Plot2 with adjusted y-axis label in the top left
        plot(subdata$DateTime, subdata$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
        # New plot in the top right
        plot(subdata$DateTime, subdata$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
        # Plot 3 with the legend box suppressed in the bottom left
